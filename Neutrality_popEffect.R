...
###------ Loading of the simulated data from 05-11
# ! Change the path to working directory !
setwd("C:/Users/Clotilde/Dropbox/Lille 1/Analyse/Normalite")
load("simuls05_11.RData")
load("simuls06_19.RData")
simuls <- merge(simuls05_11, simuls06_19,all=TRUE,sort=FALSE)
